...
/*
* Some rules on Fragment:
*   Firstly, Fragments do not directly talk to one another;
*
* */

public class MainActivity extends AppCompatActivity
        implements TopSectionFragment.TopFragmentListener{
